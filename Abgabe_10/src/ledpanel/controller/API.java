...
public class API {
     ...
     * Punkte gleichzeitig angezeigt. Die Anzeige endet, sobald der längste Pfad abgearbeitet wurde. Danach ist die
     * Anzeige wieder leer. Auch die Wiederholung beginnt erst, nachdem der längste Pfad abgearbeitet wurde.
     *
     * @param path         Der Pfad, auf dem sich der laufende Punkt bewegen soll.
     * @param milliseconds Zeitraum, für den der laufende Punkt auf einer LED verweilt.
     * @param repetitions  Anzahl der Wiederholungen.
     ...
     *
     * @param stringImage  Das anzuzeigende StringImage.
    ...
    /**
     * Diese Methode verhält sich ähnlich wie {@link #showStringImage(String, int)}, allerdings wird das StringImage
     * über das Panel bewegt. Der String erscheint am rechten Rand des Panels und scrollt zum linken Rand durch, bis er
     * ganz verschwunden ist. Am Anfang zeigt das Panel ein leeres Bild, bevor die Buchstaben erscheinen.
     * <p>
     * Die Klasse {@link MovingStringImage} soll genutzt werden, um Text in bewegte Strings zu verwandeln. Diese Klasse
     * muss implementiert werden.
     *
     * <br>
     * Beispielsweise führt der Aufruf von
     * <pre>{@code showMovingStringImage(new MovingStringImage("Herzlich Willkommen!").movingStrings(), 20, 2)}</pre>
     * zur Ausgabe eines Lauftextes, der 2-mal durchläuft. Jedes einzelne Bild ist dabei für 20 Millisekunden zu sehen.
     *
